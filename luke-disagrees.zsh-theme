## Luke Disagree's oh-my-zsh theme. Forked from MarcoPeraza them wedisagree
...
PROMPT='%{$FG[032]%}[%c$(my_git_branch_info)%{$FG[032]%}] %{$reset_color%}'
